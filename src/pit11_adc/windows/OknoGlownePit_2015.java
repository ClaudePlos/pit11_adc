 ...
 * @author k.skowronski
 */
public class OknoGlownePit_2015 extends javax.swing.JFrame {
...
//            /String test = myEntries.get(1).toString();
            ...
            Logger.getLogger(OknoGlownePit_2015.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OknoGlownePit_2015.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new OknoGlownePit_2015().setVisible(true);
            }
        });
    }
